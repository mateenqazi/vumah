...
export const findContactByUsername = (username) => {
...
export const findConversationByOtherParticipantId = (participantId) => {
...
export const findConversationByParticipantIds = (participantIds) => {
  const conversation = conversations.find((_conversation) => {
