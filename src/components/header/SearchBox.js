...
function SearchBox({ searchRef }) {
  ...
  const isSearch = pathname === '/request-booking' || pathname === '/search';
  ...
  const { placesService, placePredictions, getPlacePredictions } = useGoogle(getOptions());
            ...
            {placePredictions.map((suggestion, index) => (
              ...
              >
                <svg
                  ...
                  style={{ marginRight: 16, background: 'rgba(0, 0, 0, 0.1)' }}
                >
